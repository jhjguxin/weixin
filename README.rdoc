...
Config your api_key, api_secret and redrect_uri somewhere like development.rb.
  ...
  WeiXin::Config.api_key = "1234567890"
  WeiXin::Config.api_secret = "somethinglooksstrageandhardtoremember"
  WeiXin::Config.redirect_uri = "http://www.example.com/callback"

Ok, now you are ready to enjoy it. Sina Weibo has provided several ways to get your access token, and you can easily get it using WeiXin.
...
1.The Authorization Code strategy with response_type set to code
  ...
  # WeiXin::Client.from_code is a shortcut for client.auth_code.get_token("authorization_code_value")
  client = WeiXin::Client.from_code("authorization_code_value")
...
2.The Authorization Code strategy with response_type set to token
  ...
  client = WeiXin::Client.from_hash(:access_token => "6874dd3766b35536abcb76a9e3a57867", :expires_in => 86400)
...
Follow this link to read more about this strategy.{站内应用开发指南}[http://open.weibo.com/wiki/%E7%AB%99%E5%86%85%E5%BA%94%E7%94%A8%E5%BC%80%E5%8F%91%E6%8C%87%E5%8D%97]
  ...
  client = WeiXin::Client.from_signed_request("signed_request-posted-by-weibo")
...
You can find them in /lib/weixin/interface/.Note that all methods follow the patten of
